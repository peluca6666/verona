...
import { getProductsForAdmin, createProduct, updateProduct, createCategory } from '@/lib/api'; 
...
  async function handleSaveCategory(data: { name: string, image?: string }) {
    // createCategory call is handled by CategoryForm's onSave logic 
    // to show toast notifications on success/error.
...
            className="group relative inline-block px-8 py-3 bg-amber-100 hover:bg-amber-200 text-amber-700 font-medium tracking-[0.1em] transition-all duration-300 transform hover:scale-105"
          >
            + New Category
          </button>
          <button
            onClick={() => { setEditingProduct(null); setShowProductForm(true); }}
            className="group relative inline-block px-10 py-3 bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-white font-medium tracking-[0.1em] transition-all duration-300 transform hover:scale-105 hover:shadow-xl overflow-hidden"
          >
            + New Product
          </button>
        </div>
