                    ...
                    <div className="space-y-8 sm:space-y-12">
                        ...
                        <div className="bg-gray-50 rounded-2xl p-6 sm:p-10 hover:shadow-lg transition-shadow duration-300">
                            ...
                            <p className="text-gray-700 leading-relaxed mb-3">
                                Somos una joyería dedicada a crear piezas únicas que cuentan historias. 
                                Cada producto es cuidadosamente seleccionado para ofrecer calidad, elegancia y diseño excepcional.
                            </p>
                            <p className="text-gray-700 leading-relaxed">
                                Nuestra pasión por la joyería nos impulsa a buscar constantemente las mejores piezas 
                                y brindar a nuestros clientes una experiencia memorable.
                            </p>
                        </div>
                        ...
                        <div className="grid sm:grid-cols-2 gap-6 sm:gap-8">
                            <div className="group">
                                <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 hover:bg-amber-50 transition-colors duration-300">
                                    ...
                                    <p className="text-gray-600 text-sm leading-relaxed">
                                        Trabajamos solo con materiales de alta calidad y verificamos cada pieza 
                                        antes de ponerla a disposición de nuestros clientes.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="group">
                                <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 hover:bg-amber-50 transition-colors duration-300">
                                    ...
                                    <p className="text-gray-600 text-sm leading-relaxed">
                                        Cada cliente es único para nosotros. Ofrecemos asesoramiento personalizado 
                                        para ayudarte a encontrar la pieza perfecta.
                                    </p>
                                </div>
                            </div>
                        </div>
