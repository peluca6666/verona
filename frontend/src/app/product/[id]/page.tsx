...
export default function ProductDetailPage() {
  ...
  const images = product.images?.filter(Boolean) || (product.primary_image ? [product.primary_image] : []);
                ...
                <div className="grid grid-cols-4 sm:grid-cols-6 lg:grid-cols-4 gap-3">
                  {images.map((image, index) => (
                    <button
                      ...
                      className={`aspect-square overflow-hidden rounded-xl border-3 transition-all duration-200 ${
                        selectedImage === index 
